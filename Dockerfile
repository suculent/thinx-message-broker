...
#     org.label-schema.name="thinx-message-broker" \
#     org.label-schema.url="https://hub.docker.com/r/suculent/thinx-message-broker/" \
#     org.label-schema.vcs-ref=$VCS_REF \
#     org.label-schema.vcs-type="Git" \
#     org.label-schema.vcs-url="https://github.com/suculent/thinx-message-broker"

RUN apt-get update && apt-get install -y wget incrond && \
...
CMD ["incrontab", "--reload", "&&", "/usr/sbin/mosquitto", "-c", "/mqtt/config/mosquitto.conf"]
